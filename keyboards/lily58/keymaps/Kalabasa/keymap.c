...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(KC_ESC, KC_NO, KC_NO, KC_NO, C(G(KC_TAB)), LCTL(KC_TAB), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, C(G(KC_SPC)), KC_NO, KC_Q, KC_W, KC_F, KC_P, KC_B, KC_J, KC_L, KC_U, KC_Y, KC_EQL, KC_NO, LGUI_T(KC_TAB), KC_A, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, KC_O, KC_QUOT, KC_SCLN, KC_Z, KC_X, KC_C, KC_D, KC_V, KC_NO, KC_NO, KC_K, KC_H, KC_DOT, KC_SLSH, KC_QUES, RCTL_T(KC_ENT), MO(4), MO(3), MO(2), LT(1,KC_SPC), KC_BSPC, MO(5), MO(6), KC_RALT),
	[1] = LAYOUT(LSFT(KC_ESC), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LSFT(KC_Q), LSFT(KC_W), LSFT(KC_F), LSFT(KC_P), LSFT(KC_B), LSFT(KC_J), LSFT(KC_L), LSFT(KC_U), LSFT(KC_Y), KC_UNDS, KC_NO, KC_TRNS, LSFT(KC_A), LSFT(KC_R), LSFT(KC_S), LSFT(KC_T), LSFT(KC_G), LSFT(KC_M), LSFT(KC_N), LSFT(KC_E), LSFT(KC_I), LSFT(KC_O), KC_DQUO, KC_COLN, LSFT(KC_Z), LSFT(KC_X), LSFT(KC_C), LSFT(KC_D), LSFT(KC_V), KC_NO, KC_NO, LSFT(KC_K), LSFT(KC_H), KC_COMM, KC_BSLS, KC_EXLM, LSFT(KC_ENT), KC_NO, KC_NO, KC_NO, KC_TRNS, LSFT(KC_BSPC), KC_NO, KC_NO, KC_TRNS),
	...
	[3] = LAYOUT(KC_NO, KC_A, KC_B, KC_C, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F, KC_P7, KC_P8, KC_P9, KC_HASH, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_E, KC_P4, KC_P5, KC_P6, KC_P0, KC_P1, KC_NO, KC_RGUI, KC_RALT, KC_RCTL, KC_RSFT, KC_NO, KC_D, KC_P1, KC_P2, KC_P3, KC_X, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_TRNS),
	...
	[5] = LAYOUT(KC_ESC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), LGUI(KC_L), KC_DEL, KC_TAB, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_NO, LGUI(KC_Z), KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_BSPC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_HOME, KC_PGUP, KC_PGDN, KC_END, KC_ENT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO),
